 ...
 */
namespace Craft\Text\Lipsum\Source;

use Craft\Text\Lipsum\SourceDict;

class Pokemon extends SourceDict
{

    /** @var array */
    protected $dict = ['pokemon', 'ipsum', 'dolor', 'sit', 'amet', 'bulbasaur', 'ivysaur', 'venusaur', 'charmander', 'charmeleon',
